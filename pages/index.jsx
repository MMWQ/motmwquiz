    ...
    return (
        <div className={styles.page}>
            <div className={styles.nav}>
                ...
                <button title="Settings"><Image src="/gear-fill.svg" width={40} height={40} /></button>
            </div>

            <main className={styles.main}>
                <div className={styles.marg}>
                    <button onClick={() => setFcIndex(fcIndex - 1)}>
                        <Image src="/caret-left.svg" width={80} height={80} />
                    </button>
                </div>

                <div className={styles.flashcard} onClick={flipCard}>
                    <h1 style={{ color: flashcards[fcIndex].flipped ? "white" : "black" }}>{flashcards.length > 0 ? flashcards[fcIndex].flipped
                        ? flashcards[fcIndex][settings[flashcards[fcIndex].type + "_front"]]
                        : flashcards[fcIndex][settings[flashcards[fcIndex].type + "_back"]]
                        : "Loading..."}</h1>
                </div>
